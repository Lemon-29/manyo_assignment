...
RSpec.describe 'タスク管理機能', type: :system do
  let!(:task) { FactoryBot.create(:task, title: 'task', content: 'task', expired_at: '2021-06-03 03:33:33', status: 1) }
  let!(:task2) { FactoryBot.create(:task, title: 'task2', content: 'task2', expired_at: '2021-06-06 03:33:33', status: 2) }
  let!(:task3) { FactoryBot.create(:task, title: 'task3', content: 'task3', expired_at: '2021-06-16 03:33:33', status: 3) }
  before do
    visit tasks_path
  end
        visit new_task_path
        ...
        find("#task_expired_at_2i").find("option[value='3']").select_option
        find("#task_expired_at_3i").find("option[value='3']").select_option
        find("#task_expired_at_4i").find("option[value='3']").select_option
        find("#task_expired_at_5i").find("option[value='3']").select_option
